        ...
        <>
            ...
            <nav className="bg-blue-900 text-white px-6 py-4 shadow-md">
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    ...
                    {/* Desktop Login */}
                    <button
                        className="hidden md:block bg-blue-500 px-4 py-2 rounded-md hover:bg-blue-600"
            ...
            >
                ...
                <div className="px-6 mt-6">
                    <button
                        className="w-full bg-blue-900 text-white py-3 rounded-md text-center hover:bg-blue-950 transition"
                        onClick={() => {
                            setOpen(false);
                            navigate("/login");
                        }}
